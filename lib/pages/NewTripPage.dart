...
import 'package:yalla_r7la_new/models/add_destination_model.dart';
...
class _NewTripPageState extends State<NewTripPage> {
  ...
  Future<void> sendTripToServer() async {
    ...
    for (var xfile in imageFiles) {
      ...
      fileImages.add(File(xfile.path));
    }
    var model = AddDestinationModel(
      ...
      startDate: DateTime.parse(
        startDateController.text.endsWith('Z')
            ? startDateController.text
            : '${startDateController.text}Z',
      ),
      endDate: DateTime.parse(
        endDateController.text.endsWith('Z')
