...
//     request.fields['AvilableNumber'] = int.parse(availableNumberController.text).toString();
    
//     request.fields['StartDate'] = startDateController.text.endsWith('Z') 
//         ? startDateController.text 
//         : '${startDateController.text}Z';
//     request.fields['EndtDate'] = endDateController.text.endsWith('Z') 
...
//           const SnackBar(content: Text("One or more images are unavailable")),
//         );
//         return;
//       }
//     }
...
//         'subtitle': locationController.text,
